#ifndef SKYXSETTINGS_H
#define SKYXSETTINGS_H
...
SkyXSettings mPresets[] = {
    ...
    Ogre::Vector2(1,1),
    true, 0.5,
    Ogre::Vector3(1,0.976,0.92),
    2
    ),

    // Thunderstorm 2
    SkyXSettings(
    Ogre::Vector3(10.23, 7.5f, 20.5f),
    0, 0,
    ...
    Ogre::Vector2(1,1),
    true, 0.5,
    Ogre::Vector3(0.95,1,1),
    2
    ),

    // Desert
    SkyXSettings(
    Ogre::Vector3(9.0f, 7.5f, 20.5f),
    0.5, -0.8f,
    ...
    // Night
    SkyXSettings(
    Ogre::Vector3(21.5f, 7.5, 20.5),
    0.03, -0.25,
    SkyX::AtmosphereManager::Options(), true)
};

#endif // SKYXSETTINGS_H
