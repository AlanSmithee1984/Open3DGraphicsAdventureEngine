...
set(Hydrax_PREFIX_PATH ${HYDRAX_PREFIX_PATH})
create_search_paths(Hydrax)

set(HYDRAX_INC_SEARCH_PATH ${HYDRAX_INC_SEARCH_PATH}
${Hydrax_INC_SEARCH_PATH}
)
...
#message(${HYDRAX_INC_SEARCH_PATH})
find_path(HYDRAX_INCLUDE_DIR NAMES ${HYDRAX_HEADER_NAMES} HINTS ${HYDRAX_INC_SEARCH_PATH} ${HYDRAX_FRAMEWORK_INCLUDES} ${HYDRAX_PKGC_INCLUDE_DIRS} PATH_SUFFIXES "" "hydrax" "HydraX" "Hydrax")
#message("HYDRAX_INCLUDE_DIR: " ${HYDRAX_INCLUDE_DIR})


set(HYDRAX_LIBRARY_NAMES  ${HYDRAX_LIBRARY_NAMES}
HydraX
Hydrax
HYDRAX
hydrax
...
#message("HYDRAX_LIBRARY_NAMES: " ${HYDRAX_LIBRARY_NAMES})
...
#message("HYDRAX_LIBRARY_REL: " ${HYDRAX_LIBRARY_REL})
#message("HYDRAX_LIBRARY_DBG: " ${HYDRAX_LIBRARY_DBG})
